...
async function obtenerArtistaAleatorio() {
    try {
        const response = await fetch('http://127.0.0.1:8000/artista-aleatorio'); //127.0.0.1:8000 para pruebas locales
...
async function obtenerCancionDeArtista(artista) {
    try {
        const response = await fetch(`http://127.0.0.1:8000/canciones/${artista}`); //127.0.0.1:8000 para pruebas locales
        const data = await response.json();
